<div align="center">
<h1><img src="https://sitedrift.team/img/branding.png" width="256"></h1>
<p> Don't waste your time with compliance. SiteDrift automatically skips annoying link shorteners. </p>

<a href="https://github.com/2Tech Studio (2tech.studio) (prev FastForward)/SiteDrift/blob/main/.github/workflows/main.yml" target="_blank"> <img alt="Builds" src="https://img.shields.io/github/actions/workflow/status/2Tech Studio (2tech.studio) (prev FastForward)/sitedrift/main.yml?branch=main&label=Builds&style=for-the-badge&logo=githubactions"> </a>
...
<a href="https://chromewebstore.google.com/detail/sitedrift/icallnadddjmdinamnolclfjanhfoafe"><img src="https://user-images.githubusercontent.com/585534/107280622-91a8ea80-6a26-11eb-8d07-77c548b28665.png" alt="Get SiteDrift on Chromium based browsers" width="177"> </a>
...
<div align="center">
<a href="https://nightly.link/2Tech Studio (2tech.studio) (prev FastForward)/SiteDrift/workflows/main/main/SiteDrift_chromium.zip"> <img src="https://img.shields.io/badge/Chrome-Dev%20builds-critical?style=for-the-badge&logo=googlechrome" /> </a>
  <br>
<a href="https://nightly.link/2Tech Studio (2tech.studio) (prev FastForward)/SiteDrift/workflows/main/main/SiteDrift_firefox.zip"> <img src="https://img.shields.io/badge/Firefox-Dev%20builds-critical?style=for-the-badge&logo=firefoxbrowser" /> </a>
</div>

## Installing from Web-Stores

Currently, SiteDrift is present on the Firefox, Chrome and Edge Addons Store.

### Chrome
<a href="https://chromewebstore.google.com/detail/sitedrift/icallnadddjmdinamnolclfjanhfoafe"> <img alt="Mozilla Add-on" src="https://img.shields.io/badge/get%20the%20extension-5648de?logo=googlechrome&style=for-the-badge&logoColor=white"/> </a>

### Firefox
We have been removed from Firefox store!
We'll get back to it shortly.

<a href="https://addons.mozilla.org/firefox/addon/2Tech Studio (2tech.studio) (prev FastForward)/"> <img alt="Mozilla Add-on" src="https://img.shields.io/badge/get%20the%20extension-5648de?logo=firefoxbrowser&style=for-the-badge"/> </a>

### Edge
<a href="https://microsoftedge.microsoft.com/addons/detail/sitedrift/ldcclmkclhomnpcnccgbgleikchbnecl"> <img src="https://img.shields.io/badge/get%20the%20extension-5648de?style=for-the-badge&logo=microsoftedge&logoColor=blue" /> </a>
...
0. **REMOVE any previous versions of SiteDrift.**

1. Download the extension using [this link](https://nightly.link/2Tech Studio (2tech.studio) (prev FastForward)/SiteDrift/workflows/main/main/SiteDrift_chromium.zip). You'll end with a .zip file on your downloads, like on the screenshot below:
...
3. Now you'll have a folder called "SiteDrift_chromium". Enter it and extract (again) the file.
...
6. If you got any errors, or a message like "You're using SiteDrift in development mode", see the [Troubleshooting section](#troubleshooting).
...
Please follow [the instructions here](https://github.com/2Tech Studio (2tech.studio) (prev FastForward)/releases#installation-instructions) to install the extension using CRX mode.
</details>
...
1. Download the zip using [this link](https://nightly.link/2Tech Studio (2tech.studio) (prev FastForward)/SiteDrift/workflows/main/main/SiteDrift_firefox.zip).
2. Unzip the downloaded file so that you have `SiteDrift_firefox_X.XXXX.xpi`.
3. Open `about:config`
4. Search for `xpinstall.signatures.required`
5. Toggle `xpinstall.signatures.required` to `false` using the button on the right.
6. Restart Firefox.
7. Open `about:addons`
8. Drag your `SiteDrift_firefox_X.XXXX.xpi` into Firefox, and click "add" when prompted.
...
3. Write `SiteDrift` on Collection Name.
4. Tap "Ok".
5. Open Firefox.
6. Tap on the 3 dots.
7. Tap on Extensions.
...
<details> <summary> "You're using SiteDrift in development mode, which means that bypass definitions are loaded from your local injection_script.js and rules.json. If you would like to use the auto-updating system, delete those files and then check for updates." </summary>
  <br>
...
Copy and paste the contents of [this page](https://raw.githubusercontent.com/2Tech Studio (2tech.studio) (prev FastForward)/SiteDrift/manifest-v2/src/linkvertise.js).
