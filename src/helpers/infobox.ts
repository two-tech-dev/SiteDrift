...
export function insertInfoBox(text) {
    ...
    div.innerHTML = `<img src="https://raw.githubusercontent.com/2Tech Studio (2tech.studio) (prev FastForward)/SiteDrift/main/src/icon/48.png" style="width:24px;height:24px;margin-right:8px"><span style="display:inline"></span>`;
