...
## What We Collect
SiteDrift does not collect any personally identifiable information on its users. The only information collected is what is described below, in the Auto updating and Crowd Bypass sections.


## Auto-updating
_This section does not apply to Firefox._

In order to provide up-to-date bypasses, SiteDrift sends a request to Github every hour, and if a new commit is found, it will download the latest "injection script."
