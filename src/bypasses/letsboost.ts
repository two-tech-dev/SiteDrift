...
export default class Letsboost extends BypassDefinition {
    ...
    execute() {
        alert("SiteDrift: If nothing happens in a few seconds, the bypass couldn't be executed. Please disable your ad blocker and refresh the page. Press OK to continue.");
